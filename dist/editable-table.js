...
var _default = {
  type: 'button',
  onEdit: function onEdit(instance, extension, x, y, tdNode) {
  ...
  onUpdateCell: function onUpdateCell(instance, extension, x, y, tdNode) {
...
exports.default = _default;
},{}],"src/select.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  onClick: function onClick(instance, extension, targetNode) {
  ...
  onEdit: function onEdit(instance, extension, x, y, tdNode) {
    ...
    for (var i = 0; i < extension.options.length; i++) {
        ...
        case 'ArrowUp':
          {
            ...
            this.addListboxSelectedIndex(instance, -1, _extension.options);
            break;
          }
  ...
  onKeyUp: function onKeyUp(instance, extension, keyCode) {
    if (instance.focusType === 'Listbox') {
      switch (keyCode) {
        case 'Enter':
          {
  ...
  onPasteCell: function onPasteCell(instance, extension, x, y) {
...
var _select = _interopRequireDefault(require("./src/select.js"));
...
var EditableTable = /*#__PURE__*/function () {
  ...
  _createClass(EditableTable, [{
    ...
    key: "appendBodyRow",
    value: function appendBodyRow(y) {
      var trNode = document.createElement('tr');

      if (this.params.bodyHeaderType !== 'none') {
        var value = this.params.bodyHeaderType === 'value' ? this.params.bodies[y][0] : y + 1;
        this.appendBodyHeader(trNode, y, value);
      }

      var offsetX = this.params.bodyHeaderType === 'value' ? 1 : 0;

      for (var x = offsetX; x < this.params.bodies[y].length; x++) {
    ...
    value: function onEtceteraKeyDown(type, extension, event) {
    ...
    key: "copyCell",
    value: function copyCell(x, y, type, extension) {
    ...
    key: "pasteCell",
    value: function pasteCell(x, y, type, extension) {
    ...
    key: "callExtension",
    value: function callExtension(extension, eventName) {
...
},{"./src/button.js":"src/button.js","./src/link.js":"src/link.js","./src/select.js":"src/select.js"}]},{},["editable-table.js"], "EditableTable")